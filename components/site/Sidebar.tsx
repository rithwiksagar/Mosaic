  ...
  return (
    <div ref={sidebarRef}>
      <button
        ...
        className="fixed top-5 left-2 md:left-10 z-9999 rounded-xl bg-muted hover:bg-neutral-200 cursor-pointer p-2.5 text-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-neutral-200"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.aside
            ...
            className="fixed top-20 left-2 md:left-10 w-64 bg-muted dark:bg-neutral-900 px-4 py-14 rounded-2xl"
          >
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      activeItem === item.title
                        ...
                        : "text-neutral-500 hover:text-neutral-800 hover:bg-neutral-800 dark:text-neutral-500 dark:hover:text-neutral-200",
                    )}
                  >
                    {item.title}
                  </Link>
            ...
            <section>
              <div className="mb-2 flex items-center gap-5 px-2">
                ...
                <span className="rounded-lg bg-sky-100 dark:bg-sky-500 px-2 py-1 text-xs text-sky-600 dark:text-sky-100">
                  {components.length}
                </span>
              </div>
